...
namespace ClassLibrary.Migrations
{
    ...
    [Migration("20250520090406_AddDocumentFKToRentalTransaction")]
    partial class AddDocumentFKToRentalTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClassLibrary.Models.RentalRequest", b =>
                {
                    ...
                    b.HasOne("ClassLibrary.Models.RentalTransaction", "Transaction")
                        .WithMany()
            ...
            modelBuilder.Entity("ClassLibrary.Models.RentalTransaction", b =>
                {
                    b.HasOne("ClassLibrary.Models.Document", "Document")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_Rental_Transaction_Document");
